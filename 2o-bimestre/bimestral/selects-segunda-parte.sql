...
SELECT categoria, COUNT(*) AS total_produtos FROM produtos GROUP BY categoria HAVING COUNT(*) > 2;
...
SELECT * FROM produtos WHERE categoria IN ('Vestuário' OR 'Acessórios') AND preco BETWEEN 30 AND 50;